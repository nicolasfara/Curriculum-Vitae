...
#let refs = yaml("bibliography.yml")
...
== #headerLabs.at("pubs-journal")
#cv-refs-fix(refs, multilingual, tag: "journals", me: [Farabegoli, N.], lang: language)

== #headerLabs.at("pubs-conf")
#cv-refs-fix(refs, multilingual, tag: "conf", me: [Farabegoli, N.], lang: language)
